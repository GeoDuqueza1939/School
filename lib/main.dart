...
class TassyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'TASSY: The Task Assistant System',
      home: const TassyMain(title: 'TASSY'),
      theme: themes["theme"] as ThemeData,
      darkTheme: themes["darkTheme"] as ThemeData,
      themeMode: themes["themeMode"] as ThemeMode,
    );
  }
}

class TassyMain extends StatefulWidget {
  const TassyMain({super.key, required this.title});
  /*
